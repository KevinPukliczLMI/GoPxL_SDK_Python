"""
Receive tool string output via GDP.
...
STRING_OUTPUT_DATA_PATH = f"tools:{su.TOOL_TYPE}-0:outputs:String"
...
def main() -> int:
    return su.run_main("Receive string output via GDP.", _main, default_ip=SYSTEM_IP, default_port=CONTROL_PORT)
