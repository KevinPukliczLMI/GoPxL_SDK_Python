...
The samples are the best starting point. After `pip install`, edit `SYSTEM_IP` at the top of a sample and run it. For your own app, follow the same pattern as `samples/receive_measurement.py` or `samples/discover.py`.
